...
namespace G2rismBeta.API.Migrations
{
    ...
    [Migration("20251209181512_ModuloFinanciero")]
    partial class ModuloFinanciero
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("G2rismBeta.API.Models.Factura", b =>
                {
                    ...
                    b.Property<string>("CufeCude")
                        .HasMaxLength(200)
                        .HasColumnType("varchar(200)")
                        .HasColumnName("cufe_cude");
                    ...
                    b.Property<string>("ResolucionDian")
                        .HasMaxLength(100)
                        .HasColumnType("varchar(100)")
                        .HasColumnName("resolucion_dian");
            ...
            modelBuilder.Entity("G2rismBeta.API.Models.FormaDePago", b =>
                {
                    ...
                    b.Property<bool>("RequiereVerificacion")
                        .HasColumnType("tinyint(1)")
                        .HasColumnName("requiere_verificacion");
            ...
            modelBuilder.Entity("G2rismBeta.API.Models.Hotel", b =>
                {
                    ...
                    MySqlPropertyBuilderExtensions.UseMySqlIdentityColumn(b.Property<int>("IdHotel"));

                    b.Property<int?>("CapacidadPorHabitacion")
                        .HasColumnType("int")
                        .HasColumnName("capacidad_por_habitacion");
                    ...
                    b.Property<TimeSpan?>("CheckInHora")
                        .HasColumnType("time")
                        .HasColumnName("check_in_hora");

                    b.Property<TimeSpan?>("CheckOutHora")
                        .HasColumnType("time")
                        .HasColumnName("check_out_hora");
                    ...
                    b.Property<string>("PoliticasCancelacion")
                        .HasColumnType("text")
                        .HasColumnName("politicas_cancelacion");
                    ...
                    b.Property<bool>("TieneGimnasio")
                        .HasColumnType("tinyint(1)")
                        .HasColumnName("tiene_gimnasio");

                    b.Property<bool>("TieneParqueadero")
                        .HasColumnType("tinyint(1)")
                        .HasColumnName("tiene_parqueadero");

                    b.Property<bool>("TienePiscina")
                        .HasColumnType("tinyint(1)")
                        .HasColumnName("tiene_piscina");

                    b.Property<bool>("TieneRestaurante")
                        .HasColumnType("tinyint(1)")
                        .HasColumnName("tiene_restaurante");

                    b.Property<bool>("TieneWifi")
                        .HasColumnType("tinyint(1)")
                        .HasColumnName("tiene_wifi");
                    ...
                    b.HasIndex("Nombre", "Ciudad")
                        .IsUnique()
                        .HasDatabaseName("idx_hotel_nombre_ciudad_unique");

                    b.HasIndex("TienePiscina", "TieneGimnasio", "TieneRestaurante")
                        .HasDatabaseName("idx_hotel_servicios_premium");

                    b.ToTable("hoteles");
                });

            modelBuilder.Entity("G2rismBeta.API.Models.Pago", b =>
                {
                    ...
                    b.HasIndex("IdFactura", "Estado", "FechaPago")
                        .HasDatabaseName("idx_pago_factura_estado_fecha");

                    b.ToTable("pagos");
                });

            modelBuilder.Entity("G2rismBeta.API.Models.PaqueteTuristico", b =>
                {
                    ...
                    b.Property<string>("DestinoPrincipal")
                        .IsRequired()
                        .HasMaxLength(100)
                        .HasColumnType("varchar(100)")
                        .HasColumnName("destino_principal");

                    b.Property<string>("DestinosAdicionales")
                        .HasColumnType("json")
                        .HasColumnName("destinos_adicionales");
                    ...
                    b.Property<string>("ItinerarioResumido")
                        .HasColumnType("text")
                        .HasColumnName("itinerario_resumido");
                    ...
                    b.Property<int?>("NumeroMaximoPersonas")
                        .HasColumnType("int")
                        .HasColumnName("numero_maximo_personas");

                    b.Property<int?>("NumeroMinimoPersonas")
                        .HasColumnType("int")
                        .HasColumnName("numero_minimo_personas");
            ...
            modelBuilder.Entity("G2rismBeta.API.Models.Reserva", b =>
                {
                    b.Property<int>("IdReserva")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("FechaInicioViaje", "FechaFinViaje", "Estado")
                        .HasDatabaseName("idx_reserva_fechas_estado");

                    b.HasIndex("IdCliente", "Estado", "FechaInicioViaje")
                        .HasDatabaseName("idx_reserva_cliente_estado_fecha");

                    b.ToTable("reservas");
                });

            modelBuilder.Entity("G2rismBeta.API.Models.ReservaHotel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex("IdHotel", "FechaCheckin", "FechaCheckout")
                        .HasDatabaseName("idx_reserva_hotel_fechas");

                    b.ToTable("reservas_hoteles");
                });

            modelBuilder.Entity("G2rismBeta.API.Models.ReservaPaquete", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime>("FechaFinPaquete")
                        .HasColumnType("DATE")
                        .HasColumnName("fecha_fin_paquete");

                    b.Property<DateTime>("FechaInicioPaquete")
                        .HasColumnType("DATE")
                        .HasColumnName("fecha_inicio_paquete");
                    ...
                    b.Property<string>("Personalizaciones")
                        .HasColumnType("json")
                        .HasColumnName("personalizaciones");
                    ...
                    b.HasIndex("IdPaquete", "IdReserva")
                        .HasDatabaseName("idx_reserva_paquete_paquete_reserva");

                    b.ToTable("reservas_paquetes");
                });

            modelBuilder.Entity("G2rismBeta.API.Models.ReservaServicio", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<TimeSpan?>("HoraServicio")
                        .HasColumnType("time(6)")
                        .HasColumnName("hora_servicio");
                    ...
                    b.HasIndex("IdServicio", "IdReserva")
                        .HasDatabaseName("idx_reserva_servicio_servicio_reserva");

                    b.HasIndex(new[] { "IdReserva" }, "idx_reservaservicio_reserva");

                    b.HasIndex(new[] { "IdServicio" }, "idx_reservaservicio_servicio");

                    b.ToTable("reservas_servicios");
                });

            modelBuilder.Entity("G2rismBeta.API.Models.ReservaVuelo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("AsientosAsignados")
                        .HasMaxLength(500)
                        .HasColumnType("varchar(500)")
                        .HasColumnName("asientos_asignados");
                    ...
                    b.Property<decimal>("CostoEquipajeExtra")
                        .HasColumnType("DECIMAL(10,2)")
                        .HasColumnName("costo_equipaje_extra");

                    b.Property<int?>("EquipajeExtra")
                        .HasColumnType("int")
                        .HasColumnName("equipaje_extra");

                    b.Property<bool>("EquipajeIncluido")
                        .HasColumnType("tinyint(1)")
                        .HasColumnName("equipaje_incluido");
                    ...
                    b.Property<decimal>("PrecioPorPasajero")
                        .HasColumnType("DECIMAL(10,2)")
                        .HasColumnName("precio_por_pasajero");
                    ...
                    b.HasIndex("IdVuelo", "IdReserva")
                        .HasDatabaseName("idx_reserva_vuelo_vuelo_reserva");

                    b.HasIndex(new[] { "IdReserva" }, "idx_reservavuelo_reserva");

                    b.HasIndex(new[] { "IdVuelo" }, "idx_reservavuelo_vuelo");

                    b.ToTable("reservas_vuelos");
                });
            ...
            modelBuilder.Entity("G2rismBeta.API.Models.ServicioAdicional", b =>
                {
                    b.Property<int>("IdServicio")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("IdiomasDisponibles")
                        .HasColumnType("json")
                        .HasColumnName("idiomas_disponibles");
                    ...
                    b.ToTable("servicios_adicionales");
                });
            ...
            modelBuilder.Entity("G2rismBeta.API.Models.Factura", b =>
                {
                    b.HasOne("G2rismBeta.API.Models.Reserva", "Reserva")
                        .WithMany()
                    ...
                    b.HasOne("G2rismBeta.API.Models.Reserva", null)
                        .WithMany("Facturas")
            ...
            modelBuilder.Entity("G2rismBeta.API.Models.Pago", b =>
                {
                    b.HasOne("G2rismBeta.API.Models.Factura", "Factura")
                        .WithMany("Pagos")
                    ...
                    b.HasOne("G2rismBeta.API.Models.FormaDePago", "FormaDePago")
                        .WithMany("Pagos")
            ...
            modelBuilder.Entity("G2rismBeta.API.Models.Reserva", b =>
                {
                    ...
                    b.HasOne("G2rismBeta.API.Models.Empleado", "Empleado")
                        .WithMany()
            ...
            modelBuilder.Entity("G2rismBeta.API.Models.ReservaHotel", b =>
                {
                    b.HasOne("G2rismBeta.API.Models.Hotel", "Hotel")
                        .WithMany()
            ...
            modelBuilder.Entity("G2rismBeta.API.Models.ReservaPaquete", b =>
                {
                    b.HasOne("G2rismBeta.API.Models.PaqueteTuristico", "Paquete")
                        .WithMany()
            ...
            modelBuilder.Entity("G2rismBeta.API.Models.ReservaServicio", b =>
                {
                    ...
                    b.HasOne("G2rismBeta.API.Models.ServicioAdicional", "Servicio")
                        .WithMany()
            ...
            modelBuilder.Entity("G2rismBeta.API.Models.ReservaVuelo", b =>
                {
                    ...
                    b.HasOne("G2rismBeta.API.Models.Vuelo", "Vuelo")
                        .WithMany()
