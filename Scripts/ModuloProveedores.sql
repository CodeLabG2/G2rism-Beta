...
CREATE TABLE `proveedores` (
    ...
    `nombre_empresa` varchar(100) CHARACTER SET utf8mb4 NOT NULL,
    `nombre_contacto` varchar(100) CHARACTER SET utf8mb4 NOT NULL,
    `telefono` varchar(20) CHARACTER SET utf8mb4 NOT NULL,
    `telefono_alternativo` varchar(20) CHARACTER SET utf8mb4 NULL,
    `correo_electronico` varchar(100) CHARACTER SET utf8mb4 NOT NULL,
    `correo_alternativo` varchar(100) CHARACTER SET utf8mb4 NULL,
    ...
    `nit_rut` varchar(20) CHARACTER SET utf8mb4 NOT NULL,
    `tipo_proveedor` varchar(20) CHARACTER SET utf8mb4 NOT NULL,
    `sitio_web` varchar(200) CHARACTER SET utf8mb4 NULL,
    `calificacion` decimal(2,1) NOT NULL,
    `estado` varchar(15) CHARACTER SET utf8mb4 NOT NULL,
    `fecha_registro` datetime(6) NOT NULL,
    `observaciones` text CHARACTER SET utf8mb4 NULL,
...
CREATE TABLE `contratos_proveedor` (
    ...
    `numero_contrato` varchar(50) CHARACTER SET utf8mb4 NOT NULL,
    `fecha_inicio` datetime(6) NOT NULL,
    `fecha_fin` datetime(6) NOT NULL,
    `tipo_contrato` varchar(50) CHARACTER SET utf8mb4 NOT NULL,
    `valor_contrato` decimal(12,2) NOT NULL,
    `condiciones_pago` text CHARACTER SET utf8mb4 NOT NULL,
    `terminos` text CHARACTER SET utf8mb4 NOT NULL,
    `renovacion_automatica` tinyint(1) NOT NULL,
    `estado` varchar(20) CHARACTER SET utf8mb4 NOT NULL,
    `archivo_contrato` varchar(500) CHARACTER SET utf8mb4 NULL,
    `observaciones` text CHARACTER SET utf8mb4 NULL,
    `fecha_creacion` datetime(6) NOT NULL,
    CONSTRAINT `PK_contratos_proveedor` PRIMARY KEY (`id_contrato`),
    CONSTRAINT `fk_contrato_proveedor` FOREIGN KEY (`id_proveedor`) REFERENCES `proveedores` (`id_proveedor`) ON DELETE RESTRICT
) CHARACTER SET=utf8mb4;

CREATE INDEX `idx_contrato_estado` ON `contratos_proveedor` (`estado`);

CREATE INDEX `idx_contrato_estado_fecha_fin` ON `contratos_proveedor` (`estado`, `fecha_fin`);

CREATE INDEX `idx_contrato_fecha_fin` ON `contratos_proveedor` (`fecha_fin`);

CREATE UNIQUE INDEX `idx_contrato_numero_unique` ON `contratos_proveedor` (`numero_contrato`);

CREATE INDEX `idx_contrato_proveedor` ON `contratos_proveedor` (`id_proveedor`);

CREATE INDEX `idx_proveedor_calificacion` ON `proveedores` (`calificacion`);

CREATE INDEX `idx_proveedor_ciudad` ON `proveedores` (`ciudad`);

CREATE INDEX `idx_proveedor_estado` ON `proveedores` (`estado`);

CREATE UNIQUE INDEX `idx_proveedor_nit_unique` ON `proveedores` (`nit_rut`);

CREATE INDEX `idx_proveedor_nombre` ON `proveedores` (`nombre_empresa`);

CREATE INDEX `idx_proveedor_tipo` ON `proveedores` (`tipo_proveedor`);

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20251110205734_ModuloProveedores', '9.0.9');
