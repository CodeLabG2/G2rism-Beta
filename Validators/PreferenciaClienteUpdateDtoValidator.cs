...
{
    /// <summary>
    /// Validador para la actualización de preferencias de cliente
    /// Valida los datos para actualizar las preferencias de un cliente existente
    /// </summary>
    public class PreferenciaClienteUpdateDtoValidator : AbstractValidator<PreferenciaClienteUpdateDto>
    {
        public PreferenciaClienteUpdateDtoValidator()
        {
