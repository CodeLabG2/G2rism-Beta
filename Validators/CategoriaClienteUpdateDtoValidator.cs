...
/// <summary>
/// Validador para el DTO de actualización de categorías de cliente
/// </summary>
public class CategoriaClienteUpdateDtoValidator : AbstractValidator<CategoriaClienteUpdateDto>
{
    public CategoriaClienteUpdateDtoValidator()
    {
        // ========================================
        // VALIDACIÓN DEL ID
        // ========================================
